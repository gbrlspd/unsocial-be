...
const WRONG_USERNAME = 'Jest0';
const WRONG_PASSWORD = 'password0';
const LONG_PASSWORD = 'password9012345678901234567890123';
const LONG_USERNAME = 'Jest5678901234567';
...
describe('SignIn', () => {
  ...
  it('should throw an error if password does not exist', () => {
    const req: Request = authMockRequest({}, { username: USERNAME, password: PASSWORD }) as Request;
    const res: Response = authMockResponse();
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    jest.spyOn(authService, 'getAuthUserByUsername').mockResolvedValueOnce(null as any);
